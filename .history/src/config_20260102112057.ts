export const siteConfig = {
  ...
  aboutMe: [
    "Backend & AI engineer with experience building and operating large-scale cloud systems and production AI pipelines. I focus on platform engineering at the intersection of backend services, infrastructure, and developer experience. My work emphasizes reliability, observability, and making complex distributed systems easier to operate and reason about.",
    "Recently, I’ve been exploring AI-assisted diagnostics in distributed systems — where semantic search and LLMs help, and where they break down due to state-heavy, causality-sparse production data."
  ],
  skills: [
    "Python",
    "Go",
